...
jQuery(document).ready(function(){
	(function() {
        ...
        jQuery('#videoModal').on('shown.bs.modal', function() {
            jQuery("#videoModal .modal-body").html('<iframe width="100%" height="450" src="//www.youtube.com/embed/rs43uNelytw?&amp;showinfo=0&amp;controls=0&amp;rel=0&amp;enablejsapi=1&amp;autoplay=1" frameborder="0" allowfullscreen></iframe>');
        });
