...
- Just install the plugin and it is activated.
- Go to the Appeareance -> Delete Multple Themes and check the themes you want to delete.
- Click the delete button and approve the actions
