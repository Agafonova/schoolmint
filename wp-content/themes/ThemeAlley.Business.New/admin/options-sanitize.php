...
function of_sanitize_textarea($input) {
	...
	$custom_allowedtags["ul"] = array();
	$custom_allowedtags["li"] = array();
...
function of_sanitize_mapcode($input) {
	global $allowedposttags;
	global $themealley_business_mapallwedtags;
	$custommap_allowedtags = array_merge($themealley_business_mapallwedtags, $allowedposttags);
	$output = wp_kses( $input, $custommap_allowedtags);
	return $output;
}

add_filter( 'of_sanitize_mapcode', 'of_sanitize_mapcode' );
