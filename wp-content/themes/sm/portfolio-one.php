        	...
        	<div class="portfolio-one-item">
            	...
            	<div class="portfolio-one-item-image">
                    ...
                    ?>
                </div><!-- portfolio-one-item-image -->
                
            	<div class="portfolio-one-item-desc">
                
                	<h1 class="portfolio-one-item-desc-title">
                        <a href="
                        <?php
                    ...
                    <?php 
							...
							if( !empty( $themealley_business_portfolio_desc ) ) {
								echo '<div class="portfolio-one-item-desc-desc">';
                    ...
                    <div class="portfolio-one-item-desc-link">
                ...
                </div><!-- portfolio-one-item-desc -->                
            
            </div><!-- portfolio-one-item -->
