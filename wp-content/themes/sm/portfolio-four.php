            	...
            	<div class="portfolio-four-item-image">
                	<?php
                    ...
                    ?>
                </div><!-- portfolio-four-item-image -->
                
            	<div class="portfolio-four-item-desc">
                
                	<h1 class="portfolio-four-item-desc-title">
                        <a href="
                        <?php
                    ...
                    <?php 
							...
							if( !empty( $themealley_business_portfolio_desc ) ) {
								echo '<div class="portfolio-four-item-desc-desc">';
                    ...
                    <div class="portfolio-four-item-desc-link">
