 ...
 */
function themealley_business_customize_register_bfour( $wp_customize ) {

// Bsix Starts
	$wp_customize->add_setting(
		'themealley_business_bizfour_welcome_heading'
    );
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_welcome_text'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_welcome_link'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_welcome_list_border'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_bg_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_bg_image'
    );
	$wp_customize->add_control(
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_image_bg_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_image_bg_image'
    );
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
		$wp_customize,
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_heading_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_text_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_link_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_border_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_cta_container_bg_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_cta_container_bg_image'
    );
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
		$wp_customize,
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_cta_bg_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_cta_bg_image'
    );
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
		$wp_customize,
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_products_cta_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_quote_bg_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_quote_bg_image'
    );
	$wp_customize->add_control(
		   new WP_Customize_Image_Control(
			   $wp_customize,
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_quote_border'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_quote_text_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_quote_text_bg_image'
    );
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
		$wp_customize,
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_quote_name_text_color'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
	...
	$wp_customize->add_setting(
		'themealley_business_bizfour_quote_name_bg'
    );
	$wp_customize->add_control( 
		new WP_Customize_Color_Control( 
		$wp_customize, 
...
add_action( 'customize_register', 'themealley_business_customize_register_bfour' );
