            	...
            	<div class="portfolio-two-item-image">
                	<?php
                    ...
                    ?>
                </div><!-- portfolio-two-item-image -->
                
            	<div class="portfolio-two-item-desc">
                
                	<h1 class="portfolio-two-item-desc-title">
                        <a href="
                        <?php
                    ...
                    <?php 
							...
							if( !empty( $themealley_business_portfolio_desc ) ) {
								echo '<div class="portfolio-two-item-desc-desc">';
                    ...
                    <div class="portfolio-two-item-desc-link">
